...
function calculateSize() {
   ...
   function initFlipbook(mode) {
    ...
    /* ===== FAKE PAGE FIX (HIDDEN) ===== */

    let pages = book.querySelectorAll(".page");

    // Add fake front page if missing
    ...
    pageFlip = new St.PageFlip(book, {
        ...
        // Old UI feel + responsive
        size: isMobileLandscape ? "stretch" : "fixed",

        // Disable cover to avoid glitch
        showCover: false,

        // Use portrait only in single mode
...
//         if (currentOrientation !== window.lastOrientation) {
//             location.reload();
//         }
//     });
